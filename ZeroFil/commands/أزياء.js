...
"https://i.imgur.com/FhC4jXa.jpg",
   ...
   var callback = () => api.sendMessage({body:`صور أزياء الفلبين \عدد الصور: ${link.length}`,attachment: fs.createReadStream(__dirname + "/cache/49.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/49.jpg"), event.messageID);  
